...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_type', default='uda_ffhq_encode', type=str,
        ...
        self.parser.add_argument('--H_lr', default=0.0001, type=float, help='H learning rate')#  
        ...
        self.parser.add_argument('--dst_lambda', default=0.1, type=float, help='UDA loss multiplier factor')
        ...
        self.parser.add_argument('--board_interval', default=1, type=int,
                                 help='Interval for logging metrics to tensorboard')
        self.parser.add_argument('--val_interval', default=1000, type=int, help='Validation interval')
        self.parser.add_argument('--save_interval', default=1000, type=int, help='Model checkpoint interval')
        self.parser.add_argument('--test_save_step', default=2, type=int, help='Model checkpoint interval')
